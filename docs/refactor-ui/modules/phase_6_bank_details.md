...
## Current Expected Failures After P043
...
- `BankDetailsPage.test.tsx > targets project table, menu, date, drawer and dialog primitives`: table assertions now pass, but it still fails on P044 `Popper`/`MenuList` and P045 drawer/tag source contracts.

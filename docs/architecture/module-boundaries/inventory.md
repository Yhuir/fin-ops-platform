...
| `bank-details` | 银行明细 | 页面模块 | `/bank-details` | `../../modules/bank-details/README.md` + `../../modules/bank-details/boundary-io.md` | 模块 README 代码入口 + boundary-io + direct canonical read contract |
| `bank-account-balance` | 银行账户余额 | 资源/API 模块 | `/api/bank-details/accounts` | `../../modules/bank-account-balance/README.md` + `../../modules/bank-account-balance/boundary-io.md` | 模块 README 代码入口 + boundary-io + direct canonical read contract |
| `bank-flow-rule-batches` | 流水规则批量处理 | 页面模块 | `/bank-flow-rule-batches` | `../../modules/bank-flow-rule-batches/README.md` + `../../modules/bank-flow-rule-batches/boundary-io.md` | 模块 README 代码入口 + boundary-io + direct canonical read contract |
| `pending-invoices` | 待找发票 | 页面模块 | `/pending-invoices` | `../../modules/pending-invoices/README.md` + `../../modules/pending-invoices/boundary-io.md` | 模块 README 代码入口 + boundary-io + direct canonical read contract |
...
| `import-center` | 导入中心 | 页面模块 | `/imports` | `../../modules/import-center/README.md` + `../../modules/import-center/boundary-io.md` | 既有 import facts API + 三个导入模块 proof；无第二状态模型 |

...
| `no-oa-bank-batches` | 免OA流水批量处理 | 页面模块 | `/no-oa-bank-batches` | `../../modules/no-oa-bank-batches/README.md` + `../../modules/no-oa-bank-batches/boundary-io.md` | 模块 README 代码入口 + boundary-io + no-OA bank batch read model contract |

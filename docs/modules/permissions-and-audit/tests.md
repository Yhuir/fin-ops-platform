...
| 3. API contract tests | 适用 | `tests/test_auth_guard.py`、`tests/test_session_api.py`、`tests/test_workbench_routes.py`、`tests/test_workbench_auth_context_idempotency.py`、`tests/test_settings_data_reset_service.py`、`tests/test_oa_applicant_credentials_api.py`、`tests/test_tax_offset_api.py`、`tests/test_pending_invoice_api.py`、`tests/test_app_health_api.py` | 覆盖 401/403、session payload、关联台 direct read 权限、mutation session actor/tenant、readonly export 路由聚合 smoke、write/admin 403、dashboard admin-only、错误字段。 |

...
| `CF-E2E-002` | 关联确认/撤回后写入 relation facts，并刷新关联台和下游页面 | `workbench-relations`、`reconciliation-workbench` |
| `CF-E2E-003` | 银行流水分类确认后写入标签事实，并刷新银行明细、搜索和相关 downstream | `bank-details` |

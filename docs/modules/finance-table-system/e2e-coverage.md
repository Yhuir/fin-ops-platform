...
| `FIN-TABLE-E2E-005` | `covered` | `web/e2e/bank-details-export-download.spec.ts`、`web/e2e/pending-invoices-export-download.spec.ts`、`web/e2e/output-invoice-collections-flow.spec.ts`、`web/e2e/input-invoice-usage-flow.spec.ts`、`web/e2e/cost-statistics-flow.spec.ts`、`web/e2e/turnover-ledger-flow.spec.ts` | 覆盖当前筛选导出、不受分页限制、row-limit 和 direct payload 暂不可用禁用/失败反馈。 |
| `FIN-TABLE-E2E-006` | `covered` | `web/e2e/bank-details-stale-refreshing.spec.ts`、`web/e2e/output-invoice-collections-flow.spec.ts`、`web/e2e/input-invoice-usage-flow.spec.ts`、`web/e2e/tax-offset-flow.spec.ts`、`web/e2e/cost-statistics-flow.spec.ts`、`web/e2e/oa-pending-payments-nonfresh-flow.spec.ts`、`web/e2e/workbench-stale-error-flow.spec.ts` | 覆盖 direct empty/error 防 false-empty、防旧 rows、防导出或写入伪成功。 |
| `FIN-TABLE-E2E-007` | `covered` | `web/e2e/input-invoice-usage-flow.spec.ts`、`web/e2e/cost-statistics-flow.spec.ts`、`web/e2e/oa-pending-payments-nonfresh-flow.spec.ts`、页面级 Vitest | 覆盖详情 drawer/dialog 当前详情与暂不可用诊断。 |

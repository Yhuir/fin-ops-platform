...
- Migration `0165_remove_cost_statistics_time_tag_selection.sql` 从 canonical payload 和 `raw_payload.normalized_payload` 精确删除旧键，避免持久化旧状态污染 Settings Audit；不创建备份、不修改其他设置。

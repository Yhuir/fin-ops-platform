...
| `IN-USAGE-E2E-004` | `covered` | `web/e2e/input-invoice-usage-flow.spec.ts`、`tests/test_input_invoice_usage_oa_reverse_service.py`、`tests/test_input_invoice_usage_api.py` | Browser 已覆盖候选子集重新 preview、创建 OA 草稿、确认已提交和 submitted history 不暴露内部 batch id。 |

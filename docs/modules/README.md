...
| `no-oa-bank-batches` | 免OA流水批量处理 | legacy canonical API 模块 | `/api/no-oa-bank-batches/*` | `no-oa-bank-batches/README.md` |
...
| `cash` | 现金账 | 独立业务模块 | `/cash` + `/api/cash/*`；四子页、统一UI/表头多选已实现，实际验证与发布记录见实施§14 | `cash/README.md` |

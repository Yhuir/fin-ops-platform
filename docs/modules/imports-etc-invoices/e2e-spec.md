...
| `IMPORT-ETC-E2E-010` | derived lifecycle fan-out | `etc_import_confirmed` 必须触发 Workbench、invoice lifecycle、tax offset、cost statistics、historical ETC repair 和 search 的 dirty scope/read model refresh；页面必须通过 freshness/status 判断下游是否可读。 |

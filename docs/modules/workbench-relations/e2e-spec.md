...
| `WB-REL-E2E-008` | relation fan-out 到 invoice usage / output collection / OA pending / cost / tax / search | P1 | 关键下游页面在 relation 写后通过自己的 read model 展示一致状态；unlinked 对象不进入 linked-only 金额。 |

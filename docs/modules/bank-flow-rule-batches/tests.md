...
| 5. Frontend component and interaction tests | 适用 | loading/empty/error、筛选、分页、详情、规则抽屉、权限、提交/撤回/reset；自动选中 live batch 时详情请求携带列表项月份；每次成功写命令只触发一次当前列表 GET，不启动 freshness polling。 |

...
- 更新 `tests/test_workbench_relation_repository.py`，保护 relation fact 保存后的 downstream refresh intent scope、dedupe、relation_mode payload 和一次批量 dirty/outbox 写入。

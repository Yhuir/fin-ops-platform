...
- [OA 附件部分财务证据识别与关联闭环计划](oa-attachment-partial-financial-evidence-plan.md)：300 元住宿费 DOCX 漏识别、复用强身份关联、共享 PDF/人工预填保护、旧逻辑替换、缓存生效与生产闭环；2026-09-23 已实施，测试及发布验收见执行记录，不使用 GSD。

...
- [关联组未配对原因解释闭环计划](workbench-group-blocker-explanation-plan.md)：凭证已计入但整组仍有差额时，解释真实阻塞原因、定位差异子项、复用原审阅链路；2026-09-23 已上线，生产金额/成员/审阅未改动，功能与性能验收完成，不使用 GSD。

- [OA 附件部分财务证据识别与关联闭环计划](oa-attachment-partial-financial-evidence-plan.md)：300 元住宿费 DOCX 漏识别、复用强身份关联、共享 PDF/人工预填保护、旧逻辑替换、缓存生效与生产闭环；2026-09-23 已上线并完成功能闭环，性能限制与测试/发布验收见执行记录，不使用 GSD。

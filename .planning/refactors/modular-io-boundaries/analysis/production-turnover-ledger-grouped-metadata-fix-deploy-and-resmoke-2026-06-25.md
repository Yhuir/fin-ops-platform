...
**Target branch:** `dev`
**Target commit before deploy:** `a16ab9863ba2c2335457b2598a5a970489658bec`
**Planned release name:** `dev-turnover-grouped-metadata-a16ab986-20260625`
...
- one deploy through `./scripts/deploy-oa.sh --release-name dev-turnover-grouped-metadata-a16ab986-20260625`;
...
```bash
./scripts/deploy-oa.sh --release-name dev-turnover-grouped-metadata-a16ab986-20260625
```

Expected:

- deploy exits `0`;
- active release `RELEASE.json` points at commit `a16ab9863ba2c2335457b2598a5a970489658bec`;

...
| `09-workbench-main-closure-controller.md` | 用户授权的 Workbench 专项主控 `/goal` prompt：高效率 wave 推进 `reconciliation-workbench` 与 `workbench-relations` 的模块化代码、边界、I/O、旧路径退役、本地验证和生产证据闭环。 |

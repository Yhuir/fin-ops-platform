...
Start with `server-py:etc-reconciliation-source-upload-service-extraction`.
...
- Row328 is the next local boundary: extract generic source upload store+parse+apply orchestration into a service/facade boundary.
...
- Read `analysis/server-py-etc-reconciliation-source-upload-parser-boundary-audit-2026-06-25.md`, `analysis/server-py-etc-reconciliation-supplement-for-card-upload-callback-collapse-2026-06-25.md`, `STATE.md`, `MODULE-QUEUE.md`, `JOURNAL.md`, `NEXT-PROMPT.md`, and `12-PARALLEL-ORCHESTRATION.md`.
...
- Implement only the Row328 ETC reconciliation source upload service extraction unless a narrower safe implementation step is required first.

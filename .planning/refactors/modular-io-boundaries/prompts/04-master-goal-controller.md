...
- Branch: dev.
- Last completed controller step: post full user-scope API smoke browser/admin/write evidence selection.
...
- The next pending boundary is `production:read-model-authenticated-browser-page-smoke-runbook`.

...
Copy the full prompt below into Codex to start or resume the autonomous run. Current local-first boundary state is `server-py:turnover-ledger-relation-withdraw-route-callback-collapse-selected` after turnover ledger closure withdraw route callback collapse.

...
- `bank_account_balance` remains implementation-gap-open: app-owned refresh/derived lifecycle helpers remain, all-only worker/storage vs month/all scope policy needs accounting, operation barrier evidence needs audit, and `BankDetailReadModelRepositoryPort.list_bank_account_balances(...)` remains transition compatibility fallback.
...
- The next pending boundary is read-models:bank-account-balance-refresh-freshness-operation-barrier-audit.
...
Start with read-models:bank-account-balance-refresh-freshness-operation-barrier-audit unless planning-state reconciliation finds an inconsistency first.

For read-models:bank-account-balance-refresh-freshness-operation-barrier-audit:
- Read `.planning/refactors/modular-io-boundaries/analysis/read-model-bank-account-balance-repository-port-extraction.md`, `docs/modules/bank-account-balance/README.md`, `docs/modules/bank-account-balance/state-machine.md`, `docs/modules/bank-account-balance/tests.md`, `docs/modules/bank-account-balance/implementation-notes.md`, `docs/modules/bank-details/README.md`, `docs/modules/imports-bank-transactions/README.md`, `backend/src/fin_ops_platform/services/bank_account_balance_read_model_repository.py`, `backend/src/fin_ops_platform/services/bank_account_balance_read_model_refresh.py`, `backend/src/fin_ops_platform/services/bank_account_balance_projection.py`, `backend/src/fin_ops_platform/services/bank_details_application_service.py`, `backend/src/fin_ops_platform/services/bank_detail_read_model_repository.py`, `backend/src/fin_ops_platform/services/read_model_scope_policy.py`, `backend/src/fin_ops_platform/services/runtime_worker_registry.py`, `backend/src/fin_ops_platform/app/server.py`, `tests/test_bank_account_balance_read_model.py`, `tests/test_bank_details_sql_runtime.py`, `tests/test_bankdetail_backfill_cli.py`, `tests/test_operation_freshness_barrier.py`, and `tests/test_read_model_refresh_gateway.py`.

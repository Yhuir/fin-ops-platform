...
- Row363 is the next local boundary: audit remaining `/api/oa-pending-payments*` app-owned route callbacks and select the next bounded route-owner implementation slice.

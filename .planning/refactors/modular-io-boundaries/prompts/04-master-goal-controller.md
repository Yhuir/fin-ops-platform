...
- Branch: dev.
- Last completed controller step: post-browser data targeted smoke next-boundary selection.
...
- The next pending boundary is `browser:read-model-full-deterministic-e2e-smoke-runbook`.

...
- Branch: dev.
- Last completed controller step: read-model browser data targeted smoke runbook.
...
- The next pending boundary is `planning:post-browser-data-targeted-smoke-next-boundary-selection`.

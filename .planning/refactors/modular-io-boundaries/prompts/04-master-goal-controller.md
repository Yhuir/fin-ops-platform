...
Start with `server-py:input-invoice-usage-payment-rules-write-boundary-audit`.
...
- Row352 is the next local boundary: audit input-invoice usage payment-status-rules PUT as a settings write plus read-model refresh fan-out boundary.

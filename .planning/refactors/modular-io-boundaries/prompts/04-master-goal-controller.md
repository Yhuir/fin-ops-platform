...
Start with `server-py:etc-legacy-batch-delete-side-effect-service-audit`.
...
- Row317 is the next local boundary: audit legacy batch delete side effects and choose cleanup service extraction, operation-result port, or narrower delete callback migration.
...
- Read `analysis/server-py-etc-legacy-batch-route-owner-audit-2026-06-25.md`, `STATE.md`, `MODULE-QUEUE.md`, `JOURNAL.md`, `NEXT-PROMPT.md`, and `12-PARALLEL-ORCHESTRATION.md`.
...
- Implement only the Row317 audit/selection slice unless the audit proves a narrower safe implementation can be completed and verified immediately.
- Keep business-batch v2 route behavior out of Row317.

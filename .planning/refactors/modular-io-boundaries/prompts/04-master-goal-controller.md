...
- The next pending boundary is `planning:read-model-module-closure-worker-wave-1-prompts`.
...
Start with `planning:read-model-module-closure-worker-wave-1-prompts`.
...
- Read `analysis/read-model-module-closure-evidence-ownership-map-2026-06-25.md`, `analysis/planning-post-scope-contract-runtime-classification-next-boundary-selection-2026-06-25.md`, `analysis/production-read-model-production-evidence-matrix-read-only-sweep-2026-06-25.md`, `analysis/production-read-model-scope-contract-runtime-dry-run-classification-2026-06-25.md`, `analysis/commit-backed-state-reconciliation-2026-06-25.md`, `docs/modules/README.md`, `docs/modules/read-models/README.md`, `docs/modules/read-models/state-machine.md`, `docs/modules/read-models/tests.md`, `STATE.md`, `MODULE-QUEUE.md`, `JOURNAL.md`, `NEXT-PROMPT.md`, and `12-PARALLEL-ORCHESTRATION.md`.
- Generate concrete worker prompts and a controller analysis file from the row248 ownership map before creating any worker thread.
- Each worker prompt must include base commit, exact owned/forbidden files, required docs, architecture gates, handoff path, verification expectations, stop gates, no production mutation and no closure claim.
- If thread tools are available, create at most four worker threads only after prompt/ownership review is recorded, then track thread ids and status in the analysis file.

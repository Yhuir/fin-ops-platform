...
Start with `server-py:etc-reconciliation-route-owner-local-closure-audit`.
...
- Row332 is the next local boundary: audit ETC reconciliation route-owner residuals.
...
- Read `analysis/server-py-etc-reconciliation-upload-route-callback-collapse-2026-06-25.md`, `STATE.md`, `MODULE-QUEUE.md`, `JOURNAL.md`, `NEXT-PROMPT.md`, and `12-PARALLEL-ORCHESTRATION.md`.
...
- Execute only the Row332 ETC reconciliation route-owner local closure audit unless a narrower safe analysis step is required first.

...
Start with `server-py:etc-reconciliation-upload-route-callback-collapse`.
...
- Row331 is the next local boundary: collapse remaining thin reconciliation upload/text callbacks into route owner.
...
- Read `analysis/server-py-etc-reconciliation-ticket-root-text-service-extraction-2026-06-25.md`, `STATE.md`, `MODULE-QUEUE.md`, `JOURNAL.md`, `NEXT-PROMPT.md`, and `12-PARALLEL-ORCHESTRATION.md`.
...
- Implement only the Row331 ETC reconciliation upload route callback collapse unless a narrower safe implementation step is required first.

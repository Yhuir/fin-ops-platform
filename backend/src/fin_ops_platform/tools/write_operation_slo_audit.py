...
DEFAULT_OPERATION_EXPECTATIONS: tuple[OperationExpectation, ...] = (
    ...
    OperationExpectation("pending_invoice_attach_existing_invoice", "tax_offset", "workbench_relation_changed"),
    ...
    OperationExpectation("pending_invoice_attach_existing_invoice_with_oa", "tax_offset", "workbench_relation_changed"),

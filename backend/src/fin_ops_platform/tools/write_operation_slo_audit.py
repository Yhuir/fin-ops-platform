...
DEFAULT_OPERATION_EXPECTATIONS: tuple[OperationExpectation, ...] = (
    ...
    OperationExpectation("no_oa_tag_selection", "bank_flow_rule_batch", "no_oa_bank_batch_tag_selection_changed"),
    ...
    OperationExpectation("workbench_relation_confirm", "cost_statistics", "cost_statistics_relation_delta"),
    ...
    OperationExpectation("workbench_relation_withdraw", "cost_statistics", "cost_statistics_relation_delta"),
    ...
    OperationExpectation(
        "workbench_relation_confirm_cross_page", "cost_statistics", "cost_statistics_relation_delta"
    ),
    ...
    OperationExpectation(
        "workbench_relation_withdraw_cross_page", "cost_statistics", "cost_statistics_relation_delta"
    ),
    OperationExpectation(
    ...
    OperationExpectation("bank_flow_rule_batch_withdraw", "bank_flow_rule_batch", "workbench_relation_changed"),
    OperationExpectation("bank_flow_rule_batch_withdraw", "workbench", "workbench_relation_changed"),
    OperationExpectation("bank_flow_rule_batch_withdraw", "workbench_relation", "workbench_pair_relation_changed"),
    OperationExpectation("bank_flow_rule_batch_withdraw", "bank_detail", "workbench_relation_changed"),
    OperationExpectation("bank_flow_rule_batch_withdraw", "pending_invoice", "workbench_relation_changed"),
    ...
    OperationExpectation(
        "no_oa_bank_batch_withdraw", "bank_flow_rule_batch", "no_oa_bank_batch_changed", ("no_oa_bank_batch_withdraw",)
    ),
    OperationExpectation(

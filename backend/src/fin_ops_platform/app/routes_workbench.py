...
class WorkbenchRowDetailApiRoutes:
    ...
    def __init__(
        ...
        *,
        ...
        direct_rows_resolver: Callable[..., dict[str, dict[str, object]]],
        ...
        self._direct_rows_resolver = direct_rows_resolver
    ...
    def get_payload(self, row_id: str, *, month: str | None = None) -> dict[str, object]:
        ...
        try:
            ...
            direct_rows = self._direct_rows_resolver([row_id], month_hint=month_hint)
            if row_id in direct_rows:
                payload = {"row": direct_rows[row_id]}

            ...
            result.append(
                {
                    ...
                    "expense_content": str(item.get("expense_content") or "").strip(),
                    "reimbursement_date": str(item.get("reimbursement_date") or "").strip(),
                    "payment_method": str(item.get("payment_method") or "").strip(),
                    "invoice_kind": str(item.get("invoice_kind") or "").strip(),
                    "ticket_count": str(item.get("ticket_count") or "").strip(),

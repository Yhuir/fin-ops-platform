...
WORKBENCH_MONTH_SCOPE_SCHEMA_VERSION = "2026-07-15-formal-relation-partition-v3"
WORKBENCH_ALL_SCOPE_COMPOSED_SCHEMA_VERSION = (
    "workbench_sql_projection.composed_active_month_shards.formal_relation_partition.v3"
)

...
READ_MODEL_MANIFEST: dict[str, ReadModelManifestEntry] = {
    ...
    "bank_detail": ReadModelManifestEntry(
        ...
        freshness_proof_contract="month shard scope summary/source_versions plus current canonical category signature and current-effective dirty/outbox state",
        force_refresh_contract="gateway_force_refresh",
        operation_barrier_contract="app_status_registry_target",
        repository_port_contract=(
    ...
    "input_invoice_usage": ReadModelManifestEntry(
        ...
        freshness_proof_contract="month shard source_versions including input-invoice-semantic relation versions plus current-effective dirty/outbox state",
        force_refresh_contract="gateway_force_refresh",
        operation_barrier_contract="app_status_registry_target",
        repository_port_contract=(
    ...
    "output_invoice_collection": ReadModelManifestEntry(
        ...
        freshness_proof_contract="month shard source_versions including output-invoice-semantic relation, lifecycle and receipt versions plus current-effective dirty/outbox state",
        force_refresh_contract="gateway_force_refresh",
        operation_barrier_contract="app_status_registry_target",
        repository_port_contract=(
    ...
    "oa_pending_payment": ReadModelManifestEntry(
        ...
        freshness_proof_contract="month shard source_versions including OA source snapshot/admission/payment, pending relation, canonical relation schema and event source versions plus current-effective dirty/outbox state",
        force_refresh_contract="gateway_force_refresh",
        operation_barrier_contract="app_status_registry_target",
        repository_port_contract=(

...
APP_STATUS_DOMAIN_REGISTRY: tuple[AppStatusDomainDefinition, ...] = (
    AppStatusDomainDefinition(
        ...
        job_types=("workbench_rebuild", "oa_sync_workbench_rebuild", "workbench_matching"),
    ...
    AppStatusDomainDefinition(
        ...
        route="/tax-offset",
        worker_instances=(),
        job_types=("tax_certified_import", "tax_offset_cache_warmup"),
    ),
    AppStatusDomainDefinition(
        key="cost_statistics",
        label="成本统计",
        ...
        worker_instances=(),
        job_types=("cost_statistics_cache_warmup",),
    ),
    AppStatusDomainDefinition(
        key="bank_details",
        label="银行明细",
        route="/bank-details",
        worker_instances=(),
        job_types=("bank_transaction_import",),
    ),
    AppStatusDomainDefinition(
    ...
    AppStatusDomainDefinition(
        ...
        worker_instances=("oa-sync", "workbench-matching", "import"),

...
class NoOaBankBatchReadModelRefreshService:
    ...
    def handle_runtime_event(self, event: RuntimeQueueEvent) -> dict[str, Any]:
        ...
        if relation_mode != BANK_FLOW_RULE_BATCH_RELATION_MODE and _is_month_scope(scope_key):
            precheck_source_versions = self._application_service.read_model_scope_source_versions(scope_key=scope_key)

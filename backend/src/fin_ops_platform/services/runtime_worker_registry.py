...
RUNTIME_WORKER_REGISTRY: tuple[RuntimeWorkerRegistration, ...] = (
    ...
    RuntimeWorkerRegistration(
        instance_name="turnover-ledger-secondary",
        worker_kind="turnover-ledger-secondary-read-model",
        handler_flags=("--enable-turnover-ledger-read-model-refresh",),
        event_types=("turnover_ledger.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.turnover-ledger-secondary.env.example",
        read_model_key="turnover_ledger",
        read_model_scope_type="turnover_ledger",
    ),
    RuntimeWorkerRegistration(
    ...
    RuntimeWorkerRegistration(
        instance_name="pending-invoice",
        worker_kind="pending-invoice-read-model",
        handler_flags=("--enable-pending-invoice-read-model-refresh",),
        event_types=("pending_invoice.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.pending-invoice.env.example",
        read_model_key="pending_invoice",
        read_model_scope_type="pending_invoice",
    ),
    RuntimeWorkerRegistration(
    ...
    RuntimeWorkerRegistration(
        instance_name="invoice-lifecycle-secondary",
        worker_kind="invoice-lifecycle-secondary-read-model",
        handler_flags=("--enable-invoice-lifecycle-read-model-refresh",),
        event_types=("invoice_lifecycle.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.invoice-lifecycle-secondary.env.example",
        read_model_key="invoice_lifecycle",
        read_model_scope_type="invoice_lifecycle",
    ),
    RuntimeWorkerRegistration(
    ...
    RuntimeWorkerRegistration(
        instance_name="oa-pending-payment",
        worker_kind="oa-pending-payment-read-model",
        handler_flags=("--enable-oa-pending-payment-read-model-refresh",),
        event_types=("oa_pending_payment.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.oa-pending-payment.env.example",
        rabbitmq_env_example="fin-ops.worker.oa-pending-payment-rabbitmq.env.example",
        read_model_key="oa_pending_payment",
        read_model_scope_type="oa_pending_payment",
    ),
    RuntimeWorkerRegistration(
    ...
    RuntimeWorkerRegistration(
        ...
        worker_kind="cost-statistics-read-model",
        handler_flags=("--enable-cost-statistics-read-model-refresh",),
        event_types=("cost_statistics.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.cost-statistics.env.example",
        read_model_key="cost_statistics",
        read_model_scope_type="cost_statistics",
    ),
    RuntimeWorkerRegistration(
        instance_name="tax-offset",
        worker_kind="tax-offset-read-model",
        handler_flags=("--enable-tax-offset-read-model-refresh",),
        event_types=("tax_offset.read_model.refresh",),
        required=True,
        rabbitmq_eligible=True,
        env_example="fin-ops.worker.tax-offset.env.example",
        read_model_key="tax_offset",
        read_model_scope_type="tax_offset",
    ),
    RuntimeWorkerRegistration(

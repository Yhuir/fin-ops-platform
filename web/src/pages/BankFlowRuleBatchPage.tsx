...
function accountLabel(batch: BankFlowRuleBatch) {
...
function batchBlockingReason(_batch: BankFlowRuleBatch) {
  return "";
}
...
type BankFlowRuleDraftRequirements = Record<string, { requiresOa: boolean; requiresInvoice: boolean }>;
...
function tagPrimaryLabel(tag: BankFlowRuleBatchTagDefinition | BankFlowRuleBatchSummaryCategory | BankFlowRuleBatch) {
...
function tagSubLabel(tag: BankFlowRuleBatchTagDefinition | BankFlowRuleBatchSummaryCategory | BankFlowRuleBatch) {
...
function buildTagDrawerRows(tags: BankFlowRuleBatchTagDefinition[]): TagDrawerRow[] {
...
function requirementsFromSelection(selection: BankFlowRuleBatchTagSelection): BankFlowRuleDraftRequirements {
...
function requirementFor(requirements: BankFlowRuleDraftRequirements, tagCode: string) {
...
function relationContextLabels(row: BankFlowRuleBatchDetailRow) {
...
function bankDetailTagLabels(row: BankFlowRuleBatchDetailRow) {

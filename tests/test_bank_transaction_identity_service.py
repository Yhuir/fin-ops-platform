...
class BankTransactionIdentityServiceTests(unittest.TestCase):
    ...
    def test_same_business_fields_produce_same_key_even_when_serials_differ(self) -> None:
        ...
        self.assertEqual(first.identity_key, "bank:62220001:2026-03-23 09:15:01:outflow:88.00:acme supplies")
    ...
    def test_different_direction_amount_or_counterparty_produces_different_key(self) -> None:
        ...
        self.assertNotEqual(identity.identity_key, direction.identity_key)
        self.assertNotEqual(identity.identity_key, amount.identity_key)
        self.assertNotEqual(identity.identity_key, counterparty.identity_key)

    def test_same_serial_but_business_fields_differ_is_not_duplicate(self) -> None:
        first = self.service.identity_for_mapping(
            {
                "account_no": "62220001",
                "trade_time": "2026-03-23 09:15:01",
    ...
    def test_bank_transaction_model_is_supported(self) -> None:
        ...
        self.assertEqual(identity.identity_key, "bank:62220001:2026-03-23 09:15:01:outflow:88.00:acme supplies")

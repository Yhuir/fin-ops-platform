...
def invoice_summary_file(name: str = "进项发票20260101-20260618.xlsx") -> MockImportFile:
    return MockImportFile(
        name=name,
        content=xlsx_bytes(
            [
                ...
                [
                    "数电票(专用发票)",
                    "26312000002781821596",
                    "",
                    "",
                    "云南溯源科技有限公司",
                    "915300007194052520",
                    "中国银行上海市外高桥保税区支行 437759217161",
                    "中国（上海）自由贸易试验区泰谷路88号四层B3（2）部位 53858000",
                    "阿法拉伐（上海）技术有限公司",
                    "91310000607371000G",
                    "中国银行上海市外高桥保税区支行 437759217161",
                    "中国（上海）自由贸易试验区泰谷路88号四层B3（2）部位 53858000",
                    "2026-05-07",
                    "STSQ00071117/1126-6446-CEPHE/Vera Jin",
                    "",
                    "*通用设备*垫片板式换热器",
                    "",
                    "件",
                ...
                ["份数：1   金额：12729.20   税额：1654.80   价税合计：14384.00"],
            ],
            sheet_name="信息汇总表",
        ),
    )

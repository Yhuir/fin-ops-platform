...
class BankDetailsRoutesTests(unittest.TestCase):
    ...
    def test_routes_facade_delegates_reads_without_read_model_gate(self) -> None:
    ...
    def test_routes_facade_keeps_direct_payload_status_ok_without_read_model_gate(self) -> None:
        service = FakeBankDetailsApplicationService()

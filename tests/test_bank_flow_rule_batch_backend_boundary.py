...
class BankFlowRuleBatchBackendBoundaryTests(unittest.TestCase):
    ...
    def test_tag_rule_save_cannot_rewrite_relations_or_run_broad_lifecycle(self) -> None:
        ...
        self.assertNotIn("affected_scope_keys_for_tag_codes", body)
        self.assertIn("changed_requirement_tag_codes", body)
        self.assertIn("_requirement_recalculation_requests", body)
        self.assertIn("BANK_RELATION_REQUIREMENT_RECALCULATION_JOB_TYPE", body)
        self.assertIn("requests.commit(", body)

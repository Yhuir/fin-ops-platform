...
class PostgresCoreRepositoryTests(unittest.TestCase):
    ...
    def test_invoice_read_preserves_empty_formal_tax_rate(self) -> None:
        invoice = PostgresCoreRepository(_CaptureConnection())._invoice_from_row({
            "legacy_id": "invoice-1", "invoice_type": "input", "invoice_no": "123",
            "tax_rate": None, "raw_payload": {"normalized_payload": {"tax_rate": "0.03"}},
        })

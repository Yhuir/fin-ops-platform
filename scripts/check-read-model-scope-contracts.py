...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--repair",
        choices=("orphaned-import-facts", "invalid-read-model-scopes"),
        default="invalid-read-model-scopes",
        help="Repair/check target.",
    )
    ...
    if args.repair == "orphaned-import-facts":
        ...
        report = service.check_invalid_read_model_refresh_scopes()
